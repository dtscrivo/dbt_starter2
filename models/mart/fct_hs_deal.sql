...
--friday
 ...
 -- , case when pay_type = "PIF" AND num_payments_made > 1 then 1 else 0 end as extra_pif
  ...
  , case when id_owner in (438436065,455035854,2035145442,1845545878,597349110,626163393,980534468,597349111,626162146,1018920904,1018935239,1211781353,143772806,1332303547,1066123713,746781400,1376975821,1332303546,2027067907,1153145590,1222041825,1278796899,1300856784,1696602043,285218002,285218005,411194086,493792977,746781399,767527108) 
    OR
